...
function sendWA(){
  if(!selectedStudent) return;
  const text = "Halo, update les coding " + selectedStudent.name + ". Level: " + (selectedStudent.level || "-") + ". Total pertemuan: " + sessionCount(selectedStudent) + "x.";
  window.open("https://wa.me/" + digits(selectedStudent.phone) + "?text=" + encodeURIComponent(text), "_blank");
}
